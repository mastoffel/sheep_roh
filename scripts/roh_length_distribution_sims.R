...
IBD_df <- roh %>%
      ...
      mutate(class = case_when(length_Mb >= 25 ~ 1,
                               length_Mb < 25 &      length_Mb >= 12.5 ~ 2,
                               length_Mb < 12.5 &    length_Mb >= 6.25 ~ 4,
                               length_Mb < 6.25 &    length_Mb >=  3.125 ~ 8,
                               length_Mb <  3.125 &  length_Mb >=1.5625 ~ 16,
                               length_Mb < 1.5625 &  length_Mb >= 0.78125 ~ 32,
                               length_Mb < 0.78125 ~ 64)) %>% # 0.610683047
      ...
      group_by(run,id,class, length_class) %>%
...
IBD_df_with_0 <- IBD_df %>% 
      ...
      mutate(sum_cM = ifelse(is.na(sum_Mb), 0, sum_Mb)) %>% 
